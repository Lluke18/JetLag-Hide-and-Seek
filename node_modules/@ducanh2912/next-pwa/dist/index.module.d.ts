...
import { RuntimeCaching, WebpackInjectManifestOptions } from 'workbox-build';
...
type BlockedSharedWorkboxOptionsKeys = Extract<SharedWorkboxOptionsKeys, "exclude">;
type WorkboxTypes = {
...
declare const withPWAInit: (pluginOptions?: PluginOptions) => WithPWA;

export { FallbackRoutes, PluginOptions, withPWAInit as default, defaultCache as runtimeCaching };
